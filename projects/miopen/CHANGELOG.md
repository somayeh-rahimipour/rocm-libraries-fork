...
* [Conv] Fixed a HIPRTC compilation failure ('hip/hip_runtime.h' file not found) in the ConvDepthwiseFwd3D (gfx942/gfx950) FP16/BFP16 solver by guarding the HIP includes behind `MIOPEN_HIP_RUNTIME_COMPILE`, matching the other MIOpen HIP kernels.
