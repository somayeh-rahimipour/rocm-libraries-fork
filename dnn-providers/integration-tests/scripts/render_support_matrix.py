...
def render_markdown(units: list[ClaimUnit], max_case_ids: int) -> str:
    ...
    lines = [
        ...
        "sidecars.",
        f"Do not hand-edit — regenerate with: `{REGEN_COMMAND}`",
        "",
        *LEGEND,
    ]
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.format == "json":
        ...
        document = render_markdown(units, args.max_case_ids)
