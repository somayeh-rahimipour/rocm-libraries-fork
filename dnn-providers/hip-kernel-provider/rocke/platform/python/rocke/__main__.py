...
Each kernel family has its own runnable module:
    ...
    python -m builders.common.bake_off_implicit_gemm   --output-dir <dir>
    python -m builders.common.bake_off_direct_conv_16c --output-dir <dir>
    python -m builders.common.bake_off_direct_conv_4c  --output-dir <dir>
